...
namespace Abilities
{
    public abstract class TickableAbilityExecutorWithTimer: AbilityExecutorWithTimer, ITickableExecutor
    {
        ...
        protected TickableAbilityExecutorWithTimer(Unit unit, Unit target, Vector3 point, AbilityModel model, BattleController battleController,
