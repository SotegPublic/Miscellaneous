...
namespace Abilities
{
    public abstract class AbilityExecutorWithTimer: AbilityExecutor, ITimerExecutor
    {
        ...
        protected AbilityExecutorWithTimer(Unit unit, Unit target, Vector3 point, AbilityModel model, BattleController battleController,
