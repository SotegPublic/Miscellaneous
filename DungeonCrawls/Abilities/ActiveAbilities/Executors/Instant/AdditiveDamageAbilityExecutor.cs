...
namespace Abilities
{
    public class AdditiveDamageAbilityExecutor: AbilityExecutor
    {
        public AdditiveDamageAbilityExecutor(Unit unit, Unit target, Vector3 point, AbilityModel model, BattleController battleController) :
