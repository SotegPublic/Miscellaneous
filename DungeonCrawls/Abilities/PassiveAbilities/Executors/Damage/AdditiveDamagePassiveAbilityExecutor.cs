...
{
    public class AdditiveDamagePassiveAbilityExecutor : PassiveAbilityExecutor
    {
        public AdditiveDamagePassiveAbilityExecutor(Unit unit, Unit target, PassiveAbilityProtoModel model, BattleController battleController,
