...
{
    public class RenewalDebuffingParametersPassiveAbilityExecutor : RenewalPassiveAbilityExecutor
    {
        private float _valueBeforeChange;
        public RenewalDebuffingParametersPassiveAbilityExecutor(Unit unit, Unit target, PassiveAbilityProtoModel model, BattleController battleController,
